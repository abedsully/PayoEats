...
public class AdminController {
    ...
    public ResponseEntity<ApiResponse> approveRestaurant(@PathVariable UUID id, @RequestParam String rejectionMessage) {
        try {
            adminService.rejectRestaurant(id, rejectionMessage);
