...
BEGIN
    ...
    FOR i IN 1..15 LOOP
        ...
        INSERT INTO orders (
            ...
            dine_in_time, payment_status, customer_name
        ) VALUES (
            v_order_id,
            ...
            NOW() - (v_days_ago || ' days')::INTERVAL + INTERVAL '15 minutes',
            v_sub_total,
            v_total_price,
    ...
    FOR i IN 1..5 LOOP
        ...
        INSERT INTO orders (
            id, created_date, order_time, order_message, is_active, order_status,
            restaurant_id, customer_id, payment_begin_at, sub_total, total_price,
            cancellation_reason, customer_name
        ) VALUES (
            v_order_id,
            CURRENT_DATE - (v_days_ago || ' days')::INTERVAL,
            NOW() - (v_days_ago || ' days')::INTERVAL,
    ...
    FOR i IN 1..4 LOOP
        ...
        INSERT INTO orders (
            id, created_date, order_time, order_message, is_active, order_status,
            restaurant_id, customer_id, sub_total, total_price, customer_name
        ) VALUES (
            v_order_id,
            CURRENT_DATE,
    ...
    FOR i IN 1..3 LOOP
        ...
        INSERT INTO orders (
            id, created_date, order_time, order_message, is_active, order_status,
            restaurant_id, customer_id, payment_begin_at, sub_total, total_price,
            payment_status, payment_image_url, customer_name
        ) VALUES (
            v_order_id,
            CURRENT_DATE,
            NOW() - (v_hours_ago || ' minutes')::INTERVAL,
